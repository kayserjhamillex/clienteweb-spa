...
@Component({
  selector: 'app-loginapptemplate',
  templateUrl: './loginapptemplate.component.html',
  styleUrls: ['./loginapptemplate.component.css']
})
export class LoginapptemplateComponent implements OnInit {
  usuario: SocialUser;
  loggedIn: boolean;
  editarnombre;
  parametro = {
